...
#include "Test/TP_WeaponComponent.h"
...
// Cross Module References
	...
	TEST_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
	TEST_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
...
// End Cross Module References
	...
	{
		P_GET_OBJECT(ATestCharacter,Z_Param_TargetCharacter);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
	{
		...
		{
			ATestCharacter* TargetCharacter;
		};
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTP_WeaponComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 2352139576
	...
	template<> TEST_API UClass* StaticClass<UTP_WeaponComponent>()
	{
		return UTP_WeaponComponent::StaticClass();
	}
