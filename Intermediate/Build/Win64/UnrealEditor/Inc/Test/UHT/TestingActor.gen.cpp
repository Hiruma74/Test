...
#include "Test/TestingActor.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeTestingActor() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	TEST_API UClass* Z_Construct_UClass_ATestingActor();
	TEST_API UClass* Z_Construct_UClass_ATestingActor_NoRegister();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATestingActor_Statics::Class_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "TestingActor.h" },
	};
#endif
	...
	template<> TEST_API UClass* StaticClass<ATestingActor>()
	{
		return ATestingActor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ATestingActor);
	ATestingActor::~ATestingActor() {}
	struct Z_CompiledInDeferFile_FID_Test_Source_Test_TestingActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Test_Source_Test_TestingActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATestingActor, ATestingActor::StaticClass, TEXT("ATestingActor"), &Z_Registration_Info_UClass_ATestingActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATestingActor), 753193174U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Test_Source_Test_TestingActor_h_3711567730(TEXT("/Script/Test"),
		Z_CompiledInDeferFile_FID_Test_Source_Test_TestingActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Test_Source_Test_TestingActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
